...
exports.CreateActivyService = void 0;
...
var CreateActivyService = /** @class */ (function () {
    ...
    CreateActivyService.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var activyRepository, activy;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        activyRepository = (0, typeorm_1.getRepository)(Activy_1.Activy);
                        activy = activyRepository.create({
                            name: name,
                            activy_date: activy_date,
                            grade: grade,
                            courseUnitId: courseUnitId
                        });
                        return [4 /*yield*/, activyRepository.save(activy)];
                    case 1:
                        _b.sent();
                        return [2 /*return*/, activy];
                }
            });
        });
    };
    return CreateActivyService;
}());
exports.CreateActivyService = CreateActivyService;
